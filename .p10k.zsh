# Generated by Powerlevel10k configuration wizard on 2024-12-11 at 12:49 PST.
...
# 12h time, slanted separators, slanted heads, slanted tails, 1 line, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_CONTENT_EXPANSION='${P9K_AWS_PROFILE:-none}${P9K_AWS_REGION:+ ${P9K_AWS_REGION}}'
